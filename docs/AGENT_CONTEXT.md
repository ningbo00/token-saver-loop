...
- Package version is `1.0.8`; JSON schemas remain `version: 1`.
...
- Fixed `tsl-new-round.ps1` Markdown backtick escaping so generated prompts preserve inline code, expand round paths, and avoid control characters; regression coverage added in CLI tests.

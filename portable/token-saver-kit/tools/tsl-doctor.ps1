...
Add-Check 'project_memory' (Join-Path (Join-Path $KitDir '.ai') 'project_memory')
...
Add-Check 'status_tool' (Join-Path $PSScriptRoot 'tsl-status.ps1')
Add-Check 'memory_tool' (Join-Path $PSScriptRoot 'tsl-memory.ps1')
